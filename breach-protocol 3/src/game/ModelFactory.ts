...
export class ModelFactory {
   ...
   * instead of a rifle.
   */
  public static createGadgetViewRig(kind: 'camera' | 'breach_charge' = 'camera'): {
    root: THREE.Group;
    ...
    if (kind === 'breach_charge') {
      // Held breach charge: same C4-frame-and-blinking-LED look as the planted version in
      // plantBreachCharge(), just scaled down slightly to sit naturally in the two-hand rig.
