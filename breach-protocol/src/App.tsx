...
export default function App() {
  ...
  // Keyboard listeners for Tab (Scoreboard) and T (Chat)
  useEffect(() => {
  ...
  }, [chatOpen, inMatch, hudState.inCctvMode]);
          ...
          <div className="bg-[#0f1923]/90 border border-[#7fd6ff]/25 rounded-xl p-5 w-full max-w-3xl shadow-2xl backdrop-blur-md flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-1 text-xs">
              ...
              >
                ...
                <option value="harbor_villa">Harbor Safehouse (2F House, Coastal)</option>
                <option value="chalet">Alpine Chalet (2F House, Snowy Night)</option>
          ...
          {hudState.inDroneMode ? (
            ...
            <>
              ...
              <div className="absolute bottom-1.5 left-1/2 -translate-x-1/2 text-[11px] text-[#89a] tracking-wide text-center">
                Click to lock · WASD move · Hold LMB full auto · V melee · Shift sprint · Space rappel/vault · B breach · C crouch · Q/E lean · R reload · F ability · N loadout · 5 drone · Tab scoreboard · T chat
              </div>
            </>
          )}
